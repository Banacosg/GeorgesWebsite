  ...
  aboutInfoList: AboutInfo[] = [
    {
      ...
      description:
        "Right out of high school in 2021 I decided that I would go to RIT for the competetive opportunity it offered me in learning. I began my college career strong quickly learning the fundamentals of computers and programs while starting on my math minor. As of now I have a mathematics minor and am close to graduating college. I have grown much from my early days at RIT and can look back and see all I've learned. ",
    },
    {
      ...
      description:
        'Ever since I was young I always had a love for math. I excelled at it through public school. There was a never ending thirst for knowledge when it came to math. I was enthralled by the possibilities and utility of it. The infinite depth of math was something to be loved for an introvert. The design of it something for me to have a relationship with. It offered me a meaningful path in such a world rotten with meaninglessness. In that sense, math was my friend. When I made it to high school I took a introduction to programming class. This was directly up my alley. Similar to math in many ways and with more utility. It was a match made in heaven, for me. Eager to make this a career I continued my learning going into college. In college my learning did not stop, it grew. The love within me did not wane, it grew. I grew. Daily I dwell on the quanderies of the programs I write and math I use. I wish for the programs to be exellent and my understanding of math to be deep. I embrace the frustrating unknowing as I slog through bug after bug. I know that with every puzzle of the craft I solve the more my love and joy grows. I take solace that challenges and mysteries of life are without end. Without them what would there be to overcome or understand?',
    },
    {
      title: 'Goals',
