...
export class AboutinfoService {
  ...
  aboutInfoList: AboutInfo[] = [
    ...
    },
    {
      ...
      description:
        "In this current season of my life, I wish for a job in the software development field. I'm not particular about the position I work in. Front-end or back-end. Testing or development. There are some things I do desire. I want to do things I don't know how to do. I want to do something difficult. I want a team that pushes me forward. Let me explain. When I was a child I knew nothing. I didn't know how to get dressed, how to read or run. Yet I wanted to go to college to be an engineer. Why would a person who can't read even dream about doing something so impossible? It is because he had hope. He couldn't say he knew how to. He couldn't show any of his skills because he had none. Yet this dream was achieved. I find myself in a similar position. I won't lie and dare say that I know everything I need to for any job. I have the first fruits of progress in the projects I create but still a long way to go. It is for that very reason, that I have a long way to go, that I wish to work a job I don't understand. If I do nothing but what I'm familiar with in my life I will never reach my goals. What choice do I have? I am a flower quickly fading! If as a child I had given up my dreams and never learned or changed I would never have gone to college. That child had to let the world he lived in go away and learn to live in a new one. Every day is a process of learning and ushering the new in. When it comes to learning it can't be any other way. So I still am like my youthful self, I still dream big dreams and in that sense, I long for the unexpected. Now that it is clear why I want to do something I don't know how to do, I must explain why I must do something difficult. I have had the displeasure of working a job where the work I was assigned didn’t amount to much. My job lacked meaning. For something to have meaning it must be fought for with no guarantee of success. It must be reaching out for what’s good. It must be difficult. If something is gained without any work then it doesn’t mean much. It wasn’t hard to gain so it won’t be terrible if it went away. However, what drives and sustains me is when my work makes a difference. When I’m given an assignment that will help someone. When it is something no one else wants to do, but it would greatly benefit the recipient. However, making a difference is difficult and if it were easy it would already have been done. Still no matter the challenge I want to take on the task of making a positive difference. This work is full of meaning not in spite of the difficulty, but because of it. So I want a team that works hard to create good products.This leads to my last point; I want a team that pushes me forward. Some of the moments of my life I look back on most fondly are those where I’m part of a team that really wants something. What immediately comes to mind is my high school soccer team which wanted the state championship. Day after day for months on end we’d practice. As iron sharpens iron we became better all with the aim of winning. Even though we came up a few minutes short of our goal I regret only not trying harder. That soccer team made me a better person. So I wish to be a part of another team like that. That starts with the team wanting something important. Maybe to change an industry for the better. Or change the world to be a better place. If the team I work for longs to see their grand visions to the end, they will supportively push me along with them. I would be glad to join them in their mission. So to any employers reading this, if you have something new, full of meaning, and a team bursting with eagerness then truly I am yours.",
    },
    {
      title: 'Hobbies',
